...
@file:DependsOn("org.jetbrains.kotlin:kotlin-script-runtime:1.9.25")
@file:DependsOn("org.jetbrains.kotlin:kotlin-main-kts:1.9.25")
@file:DependsOn("org.jetbrains.kotlin:kotlin-stdlib-jdk8:1.9.25")
