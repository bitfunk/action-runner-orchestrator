...
@file:DependsOn("org.jetbrains.kotlin:kotlin-script-runtime:2.4.10")
@file:DependsOn("org.jetbrains.kotlin:kotlin-main-kts:2.4.10")
@file:DependsOn("org.jetbrains.kotlin:kotlin-stdlib-jdk8:2.4.10")
