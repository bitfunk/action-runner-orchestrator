...
@file:DependsOn("org.jetbrains.kotlin:kotlin-script-runtime:2.0.21")
@file:DependsOn("org.jetbrains.kotlin:kotlin-main-kts:2.0.21")
@file:DependsOn("org.jetbrains.kotlin:kotlin-stdlib-jdk8:2.0.21")
