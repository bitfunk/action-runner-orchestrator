...
@file:DependsOn("org.jetbrains.kotlin:kotlin-script-runtime:1.8.10")
@file:DependsOn("org.jetbrains.kotlin:kotlin-main-kts:1.8.10")
...
@file:DependsOn("io.ktor:ktor-client-logging-jvm:2.2.4")
