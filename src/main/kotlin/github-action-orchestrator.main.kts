...
@file:DependsOn("io.ktor:ktor-client-core-jvm:2.2.4")
@file:DependsOn("io.ktor:ktor-client-cio-jvm:2.2.4")
@file:DependsOn("io.ktor:ktor-client-logging-jvm:2.2.4")
@file:DependsOn("io.ktor:ktor-client-content-negotiation-jvm:2.2.4")
@file:DependsOn("io.ktor:ktor-serialization-gson-jvm:2.2.4")
